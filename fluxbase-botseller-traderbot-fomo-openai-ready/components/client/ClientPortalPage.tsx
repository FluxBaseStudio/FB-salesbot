...
const portalCopy = {
  pl: {
    ...
    ctaSmall: "Załóż własnego SalesBota", ctaStrong: "Nowa kampania", ctaButton: "{t.ctaButton}", logout: "{t.logout}", logoutNote: "Dla bezpieczeństwa wyloguj się po zakończeniu pracy.", traderLink: "TraderBot – panel rynku", traderNote: "Prawdziwy trading wymaga uprawnień administratora.",
  ...
  en: {
    ...
    ctaSmall: "Start your own SalesBot", ctaStrong: "New campaign", ctaButton: "Start now", logout: "Log out", logoutNote: "For safety, log out when you finish working.", traderLink: "TraderBot – market panel", traderNote: "Live trading requires admin permissions.",
        ...
        <Sidebar
          ...
          footer={
            <>
              ...
              <button className="button primary-soft span" type="button" onClick={() => { window.location.href = "/trader"; }}>
                {t.traderLink}
              </button>
              <small className="sidebar-security-note">{t.traderNote}</small>
