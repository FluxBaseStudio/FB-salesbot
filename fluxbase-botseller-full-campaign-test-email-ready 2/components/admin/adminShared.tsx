...
export type TabId = "dashboard" | "operations" | "bots" | "clients" | "campaigns" | "leads" | "messages" | "runs" | "queue" | "suppression" | "audit" | "billing" | "orders" | "settings";
...
export function formatPrice(value: number | null) {
  ...
  return `${new Intl.NumberFormat("pl-PL", { style: "currency", currency: "PLN", maximumFractionDigits: 0 }).format(value)} netto`;
}
