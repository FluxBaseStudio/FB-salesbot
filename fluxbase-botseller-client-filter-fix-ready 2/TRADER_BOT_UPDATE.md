...
4. Włącz tryb `approval_required` albo `automatic`.
5. Cron `/api/cron/trader-live-executor` tworzy propozycje lub wykonuje logikę live zgodnie z zabezpieczeniami.
