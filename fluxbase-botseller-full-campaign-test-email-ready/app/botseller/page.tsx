  ...
  return (
    <main className="public-page openai-public-page">
      ...
      <section className="pricing-grid">
        {BOTSELLER_PLANS.map((item) => (
          ...
          >
            ...
            <b>{item.pricePln.toLocaleString("pl-PL")} zł / mies.</b>
            <small>{item.monthlyEmails.toLocaleString("pl-PL")} maili miesięcznie · płatność Stripe</small>
      ...
      <section className="public-summary">
        ...
        <div><span>Cena</span><strong>{plan.pricePln} zł/mies.</strong></div>
        ...
        {step === 0 ? (
          <section className="form-section">
            ...
            <p className="form-section-lead">
              ...
              {plan.pricePln.toLocaleString("pl-PL")} zł miesięcznie. Możesz zmienić wybór, klikając kartę powyżej.
            </p>
          ...
          <section className="form-section">
            ...
            <div className="mailbox-mode-card">
              ...
              <label className="mode-option extra-mailbox-option">
                ...
                <span>Dodaj drugą skrzynkę wysyłkową +50 maili dziennie za 599 zł/mies. Odpowiedzi nadal będą trafiać na jeden główny email.</span>
              </label>
            </div>
        ...
        {step === 4 ? (
          <section className="form-section">
            ...
            <div className="public-summary">
              ...
              <div><span>Cena abonamentu</span><strong>{plan.pricePln} zł / miesiąc</strong></div>
              <div><span>Rozliczenie</span><strong>Płatność cykliczna miesięczna, automatycznie odnawiana</strong></div>
              <div><span>Dodatkowa skrzynka</span><strong>{form.additional_mailbox_requested ? "599 zł / miesiąc" : "Nie"}</strong></div>
              <div><span>Łącznie</span><strong>{plan.pricePln + (form.additional_mailbox_requested ? 599 : 0)} zł / miesiąc</strong></div>
