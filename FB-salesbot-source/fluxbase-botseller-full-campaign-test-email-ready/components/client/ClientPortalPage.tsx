  ...
  return (
    <Panel eyebrow="Subskrypcja" title="Plan i użycie">
      <div className="subscription-card">
        ...
        <div>
          <strong>{data.client.subscription_price ? `${data.client.subscription_price.toLocaleString("pl-PL")} zł / mies.` : "Plan aktywny"}</strong>
      ...
      <div className="subscription-card addon-card">
        ...
        <div>
          ...
          <span>+50 maili dziennie za 599 zł/mies. SalesBot rozdzieli wysyłkę na dwie skrzynki, a odpowiedzi mogą trafiać na jeden główny adres.</span>
        </div>
