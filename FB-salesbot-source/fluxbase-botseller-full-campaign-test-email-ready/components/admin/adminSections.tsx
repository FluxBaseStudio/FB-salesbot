        ...
        <div className="compact-list separated">
          {BOTSELLER_PLANS.map((plan) => (
            <div className="compact-row" key={plan.id}>
              ...
              <span>{plan.dailyEmails} maili dziennie · {plan.monthlyEmails} maili/mies. · {plan.pricePln} zł/mies. · lookup: {plan.lookupKey}</span>
            </div>
          ))}
        </div>
      </Panel>
                ...
                <>
                  <div className="order-detail-layout">
                    ...
                    <OrderSection title="Pakiet i płatność">
                      ...
                      <DetailItem label="Dodatkowa skrzynka" value={order.additional_mailbox_requested ? `Tak · +${order.additional_mailbox_daily_emails || 50} maili/dzień · ${order.additional_mailbox_price_pln || 599} zł/mies.` : "Nie"} />
                    ...
                    <OrderSection title="Konfiguracja skrzynki">
                      ...
                      <DetailItem label="Dodatkowa skrzynka" value={order.additional_mailbox_requested ? "Tak, płatna opcja 599 zł/mies." : "Nie"} />
                    </OrderSection>
